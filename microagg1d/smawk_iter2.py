...
def _smawk_iter(row_start, row_stop, col_start, col_stop, calculator, result):
    ...
    __smawk_iter(row_start, row_stop, col_start, col_stop, calculator, result, col_starts, col_buffer)

@njit
def __smawk_iter(row_start, row_stop, col_start, col_stop, calculator, result, col_starts, col_buffer):
    if row_start-row_stop == 0 or col_stop-col_start==0:
        return
    ...
    while True:
        ...
        #print(S)
        col_starts[depth+2] = col_starts[depth+1]+reduce_iter(curr_start, step_size, row_len, cols, calculator, S)
