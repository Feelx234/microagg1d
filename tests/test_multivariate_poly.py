...
from microagg1d.multivariate_poly import set_both_seeds, forest2



class TestMultivariatePoly(unittest.TestCase):
    def get_example_1(self):
        return np.array([[1,2], [2,0], [1,0], [4,5],[5,3],[3,4]], dtype=np.int64)
